            ...
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
                        Te ayudamos a conectar y operar FIFER.
                    </p>
                    <a href="mailto:legal@fifer.app" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">legal@fifer.app</a>
                </div>
