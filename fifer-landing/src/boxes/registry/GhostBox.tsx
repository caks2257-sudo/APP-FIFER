  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h4 className="text-base font-medium text-[#F9FAFB] mb-2">Sin proyectos en revisión</h4>
        ...
        <button
          type="button"
          className="flex items-center gap-2 px-4 py-2.5 bg-[#EAB308] text-[#0A0F1E] text-sm font-medium rounded-xl hover:bg-[#EAB308]/90 transition-all"
        >
