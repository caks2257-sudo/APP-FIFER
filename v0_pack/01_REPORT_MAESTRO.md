...
| **src/** (motor) | Servidor Node (`server.js`), rutas `/api/v1/master/*`, finanzas, campañas, afiliados, pipelines IA y workers en background. Fuente de verdad de negocio para el landing. | [`src/_xray_v0_local.md`](../src/_xray_v0_local.md) |
