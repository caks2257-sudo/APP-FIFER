...
export default function ActivityBox() {
  return (
    ...
    >
      <div className="space-y-3">
        {activities.map((activity) => {
          ...
          return (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg ${style.bgClass} flex items-center justify-center flex-shrink-0`}
              >
      ...
      <button
        type="button"
        className="mt-4 w-full py-2 text-xs text-[#EAB308] hover:bg-[#EAB308]/10 rounded-lg transition-all"
      >
