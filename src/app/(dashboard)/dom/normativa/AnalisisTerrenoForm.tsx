...
export default function AnalisisTerrenoForm({ onSubmit, loading }: Props) {
  ...
  return (
    <form
      ...
      noValidate
    >
      <h2 className="text-lg font-semibold text-[#F9FAFB]">Parámetros del predio</h2>
      <p className="mt-1 text-sm text-[#94A3B8]">
        Ingrese datos para el análisis normativo (referencia OGUC / LGUC).
      </p>
      ...
      <div className="mt-8 border-t border-[#1E293B] pt-6">
        ...
        >
          {loading ? 'Ejecutando…' : 'Ejecutar Análisis Normativo'}
        </button>
      </div>
    </form>
  );
