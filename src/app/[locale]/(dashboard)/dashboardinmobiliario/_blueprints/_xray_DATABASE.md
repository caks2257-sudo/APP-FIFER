# Espejo técnico — Persistencia (App `dashboardinmobiliario`)

## UBICACIÓN LÓGICA

`FIFER://APP/DASHBOARD_INMOBILIARIO`

**Persistencia propia:** esta ruta no declara modelos Prisma adicionales; consume el **esquema compartido** del monorepo.  
